function populateQuiz() {
    ...
    video_text = document.createElement('p');
    video_text.innerHTML = "<a href='" + quiz_item["video"] + "'>Video Link Here (will be changed to a embedded video player later)</a>";
    quiz_video.appendChild(video_text);
